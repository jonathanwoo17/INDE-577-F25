...
__all__ = ["decision_tree", "KNN","SingleNeuron", "LogisticRegression", "euclidean_distance", "manhattan_distance", "pairwise_euclidean", 
           "pairwise_distances", "classification_error", "mean_squared_error", "NeuralNetwork", "Perceptron", "majority_vote", "average_label",
           "train_test_split", "standardize_fit", "standardize_transform", "minmax_fit", "flatten_images", "make_xy_dataframe", "regression_tree",
           "DBScan", "community_detection", "k_means_clustering", "pca"]
